...
def extended_optim_cfg(cfg):
    ...
    # Preserve the gradient of the corresponding effective batch when using
    # microbatches.  This is opt-in so historical GraphGPS configurations keep
    # their original accumulated-sum behavior.
    cfg.optim.batch_accumulation_normalize = False
