...
def extended_cfg(cfg):
    ...
    # LoG's tuned LRGB configurations enable representation-smoothing
    # diagnostics during validation/test.  These are logging-only metrics and
    # do not change optimization or checkpoint selection.
