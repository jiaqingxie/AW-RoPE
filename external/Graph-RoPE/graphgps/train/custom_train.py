...
from graphgps.utils import (cfg_to_dict, dirichlet_energy, flatten_dict,
                            make_wandb_name, mean_average_distance, mean_norm)
...
def train_epoch(logger, loader, model, optimizer, scheduler, batch_accumulation):
    ...
    for iter, batch in enumerate(loader):
        ...
        backward_loss = (
            ...
            if cfg.optim.batch_accumulation_normalize
            else loss
        )
